In this project, we build a primitive chatbot which can answer few questions related to C++. We use WxWidgets library for the GUIs. I worked on this project as a part of Udacity C++ course.
